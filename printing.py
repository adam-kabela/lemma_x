...
family = logging.FileHandler("F.py")
...
def log_intro():
    ...
    log_family("# The list of all multigraphs from family F by their edges")
    log_family("F = []")
...
def log_problem(P):
    if len(P[1]) == 0:
        ...
        log_proof("Subdivided diamant D1", P[1], "contains vertex", P[0], "and", P[0], "should have a neighbour outside D1.")
    elif len(P[1]) == 6: #K2_4 -- its 6 vertices
        if len(P[0]) == 2:
            log_proof("subgraph C6halved", P[1], "so some of", P[0], "should have an additional neighbour.")    
        elif len(P[0]) == 4:
        ...
        log_proof("multigraph from K^{M}_{4,P_4}", P[1], "so some of", P[0], "should have a greater degree sum.")
