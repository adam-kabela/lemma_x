...
logging.info("# This file is generated by find_hamiltonian_paths.py. The file contains lists of Hamiltonian paths.")
logging.info("# Each list is related to one multigraph from the family F and certifies that the line graph of the multigraph is Hamiltonian connected.")
logging.info("# This file can be easily used in another Python program by: from hamiltonian_connectedness_certificate import *")
